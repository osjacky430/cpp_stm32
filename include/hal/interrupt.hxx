...
class Interrupt {
 ...
 private:
	...
	static constexpr void WRAP_TO_C_STYLE_FUNC(void* const t_null_ptr) noexcept {
		Func();
	}

	static inline std::tuple<void*, void (*)(void* const) noexcept> m_callback{
 ...
 public:
	...
	template <typename Class, MemberFuncPtr<Class> MemberFunc>
	static constexpr void attachInterrupt(Class* const t_this_ptr) noexcept {
	...
	static constexpr void attachInterrupt() noexcept {
