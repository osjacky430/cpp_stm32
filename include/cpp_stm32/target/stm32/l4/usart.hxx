...
template <UsartNum Port>
constexpr void usart_send(std::uint8_t const& t_data) noexcept {
...
template <UsartNum Port>
constexpr auto usart_wait_rx_not_empty() noexcept {
...
template <UsartNum Port>
constexpr auto usart_send_blocking(std::uint8_t const& t_data) noexcept {
...
constexpr void usart_clear_flag() noexcept {
