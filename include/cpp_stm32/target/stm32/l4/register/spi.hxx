...
SETUP_REGISTER_INFO(CR2BitList,														/**/
										...
										Bit<1, FifoThreshold>{BitPos_t{12}},	// FRXTH
...
SETUP_REGISTER_INFO(SRBitList,															/**/
										StatusBit<2, FifoLevel>{BitPos_t{11}},	// FTLVL
										StatusBit<2, FifoLevel>{BitPos_t{9}},		// FRLVL
...
template <FifoThreshold FT>
static constexpr auto IO_SIZE = FT == FifoThreshold::Byte ? Access::Byte : Access::HalfWord;

template <Port SPI, FifoThreshold FT>
static constexpr Register<DRBitList, DRField, IO_SIZE<FT>> DR{BASE_ADDR(SPI), 0x0cU};
/**@}*/
