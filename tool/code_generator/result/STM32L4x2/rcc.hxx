...
SETUP_REGISTER_INFO(CFGRBitList, /**/
					...
					Bit<3>{BitPos_t{8}},	// PPRE1
					Bit<3>{BitPos_t{11}},	// PPRE2
...
SETUP_REGISTER_INFO(PLLCFGRBitList, /**/
					...
					Bit<2>{BitPos_t{0}},	// PLLSRC
					Bit<3>{BitPos_t{4}},	// PLLM
					Bit<7>{BitPos_t{8}},	// PLLN
					Binary<>{BitPos_t{16}},	// PLLPEN
					Binary<>{BitPos_t{17}},	// PLLP
					Binary<>{BitPos_t{20}},	// PLLQEN
					Bit<2>{BitPos_t{21}},	// PLLQ
					Binary<>{BitPos_t{24}},	// PLLREN
					Bit<2>{BitPos_t{25}}	// PLLR
					)
...
SETUP_REGISTER_INFO(CRRCRBitList, /**/
					StatusBit<9std::uint16_t>{BitPos_t{7}},	// HSI48CAL
